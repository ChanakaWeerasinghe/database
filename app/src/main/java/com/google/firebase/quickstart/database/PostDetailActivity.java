...
import com.google.firebase.quickstart.database.notification_f.Config;
import com.google.firebase.quickstart.database.notification_f.NotificationUtils;
...
//    }
    private void postDelete() {
        Log.d("Done","Done");
        final String uid = getUid();
        FirebaseDatabase.getInstance().getReference().child(uid).child("user-posts").removeValue();
